        ...
        <div className="router-main-box">
          ...
          <div className="emojoi-main-section">
            <div className="first-handle-box">
              <p className="yoly"><b>Project initiation</b></p>
              <div className="line-lg">
                <hr className="spliti" />
                <img src={img21} alt="logo" className="white-circle1"></img>
              </div>
            </div>
            <div className="second-handle-box">
              <p className="desdiging"><b>Design</b></p>
              <p className="olo">
            ...
            <div className="third-handle-box">
              ...
              <p className="devo"><b>Development</b></p>
            </div>
            ...
            <div className="fourth-handle-box">
              ...
              <p className="quaitty"><b> Quality Assurance</b></p>
            </div>
            <div className="double-drop-link">
              <hr className="pickku" />
              <img src={img21} alt="logo" className="white-circle"></img>
            ...
            <div className="fourth-handle-box">
              ...
              <p className="quaitty"><b>Final Launch</b></p>
            </div>
            <div className="double-drop-link">
              <hr className="pickku" />
              <img src={img21} alt="logo" className="white-circle"></img>
